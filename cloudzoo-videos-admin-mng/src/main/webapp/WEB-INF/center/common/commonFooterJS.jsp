...
<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.43.16:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.43.16:8080/mvc"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://148.70.151.67/cloudzoo-videos-mini-api"/> -->
<!-- <input type="hidden" id="bgmServer" name="bgmServer" value="http://47.107.45.5/mvc"/> -->
