...
<h1 class="page-title">动物云短视频后台管理系统</h1>
	...
	<div class="col-lg-6 col-xs-12 col-sm-12">
		...
		<div class="portlet light portlet-fit bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-microphone font-dark hide"></i> <span
						class="caption-subject bold font-dark uppercase"> 平台技术简介</span> <span
						class="caption-helper">小程序后台接口 + 短视频后台管理</span>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="mt-widget-3" style="padding-top: 15px;">
							<p class="desc">
								<font style="font-size: 16px;"><b>小程序api - 技术选型：</b></font>
							</p>
	...
	<div class="col-lg-6 col-xs-12 col-sm-12">
		...
		<div class="row" style="margin-top: 15px;">
			<div class="col-md-12">
				<div class="mt-widget-3" style="padding-top: 15px;">
					<p class="desc">
						<font style="font-size: 16px;"><b>短视频后台 - 技术选型：</b></font>
					</p>
